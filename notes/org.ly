...
CredoOrgano = {
  \relative c {
    ...
    e c! f a
    c2 c, %10
    \clef treble << { g''2. g4 a b } \\ { e,2. e4 f g } >>
    \clef "treble_8" f e
    d c \clef bass b a
    g f e d
    e2 f %15
    ...
    d2 \clef treble << {
      ...
      r d,
      f4 d
    } >> \clef "treble_8" a2^\critnote
    b4 a \clef bass d,2 %75
    f4 d a'2
    b1
    a
    \clef treble d2.-! e4-!
...
CredoBassFigures = \figuremode {
  ...
  <5 4>2 <\t 3>
  <8>2. <7>4
  <8 6>1 \once \bassFigureExtendersOn
  q2 \bo <[10] 8>4 \bc <[9] 7> %25
  <8 6>2. \once \bassFigureExtendersOn q4
  <7>2 <5>
  <6 5> <5>
  <6 5> <_!>
  r1 %30
